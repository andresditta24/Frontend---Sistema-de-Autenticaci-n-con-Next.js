...
// import MenuOpcionHeader from "./menu/menuoption";
        ...
        <header
            ...
            <div className='flex flex-wrap items-center gap-4'>
                ...
                <div id="collapseMenu"
                    ...
                    <ul
...

                        {
                            ...
                            // MenuOpcion.map((opcion) => (
                            //     < MenuOpcionHeader text={opcion.text} path={opcion.path} />
                            // ))
                ...
                <div className='flex ml-auto'>
                    <button className='mr-6 font-semibold border-none outline-none'><Link href='/auth/login'
                        className='text-blue-600 hover:underline'>Login</Link></button>
